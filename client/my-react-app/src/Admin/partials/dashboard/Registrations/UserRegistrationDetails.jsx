                            ...
                            <div className="w-full p-8 bg-white shadow-2xl rounded-2xl md:p-20 lg:w-3/4">
                                ...
                                <div className="grid gap-10 md:grid-cols-3">
                                    ...
                                    <div className="col-span-1 sm:col-span-1">
                                        ...
                                        <input
                                            ...
                                            readOnly={!isEditing}
                                            onChange={(e) =>
                                                setFormData({ ...formData, selectedExam: e.target.value })
                                            }
                                        />
                                    </div><div className="col-span-1 sm:col-span-1">
                                        <label className="block mb-2 text-xl font-medium">
                                            Exam
                                        </label>
                                        <input
                                ...
                                <div className="grid gap-10 md:grid-cols-2">
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            readOnly={!isEditing}
                                            onChange={(e) =>
                                                setFormData({ ...formData, fatherNumber: e.target.value })
                                            }
                                        />
                                    </div>
                                </div>
                                ...
                                <div className="grid gap-10 md:grid-cols-2">
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            readOnly={!isEditing}
                                            onChange={(e) =>
                                                setFormData({ ...formData, zipcCde: e.target.value })
                                            }
                                        />
                                    </div>
                                    <div>
                                ...
                                <div>
                                        ...
                                        <input
                                            ...
                                            readOnly={!isEditing}
                                            onChange={(e) =>
                                                setFormData({ ...formData, examOn: e.target.value })
                                            }
                                        />
                                    </div>
                                    {/* <div>
