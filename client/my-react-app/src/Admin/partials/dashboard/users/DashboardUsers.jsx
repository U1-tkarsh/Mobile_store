      ...
      <div className="overflow-hidden border rounded-lg shadow-2xl">
        <table className="min-w-full py-3 divide-y divide-gray-200 table-fixed">
          <thead className="bg-gray-200">
            <tr>
              <th className="w-1/6 px-6 text-center py-4 font-bold tracking-wider text-gray-900 uppercase border-b text-md">
                S.No
              </th>
              <th className="w-1/6 px-6 text-center py-3 font-bold tracking-wider text-gray-900 uppercase border-b text-md">
                User Name
              </th>
              <th className="w-1/6 px-6 text-center py-3 font-bold tracking-wider text-gray-900 uppercase border-b text-md">
                Email
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {Array.isArray(forms) && forms.length > 0 ? (
              forms.map((user, index) => (
                <tr key={user._id}>
                  <td className="w-1/6 px-4 text-center py-2 font-medium border-b cursor-pointer whitespace-nowrap">
                    {index + 1}
                  </td>
                  <td className="w-1/6 px-4 text-center py-2 font-medium border-b whitespace-nowrap">
                    {user.username}
                  </td>
                  <td className="w-1/6 px-4 text-center py-2 font-medium border-b whitespace-nowrap">
                    {user.email}
